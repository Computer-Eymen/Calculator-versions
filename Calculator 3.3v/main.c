...
int divisionResult;
int remainderFindingResult;
double piOperationCount;
...
float usResult;
int squarerootCount;
int squarerootResult;
float base, height, area;
float side, areaofsquare;
float shortSide, longSide, areaofrectangle;
float side1, side2, side3, perimeteroftriangle;
float perimeterofsquare;
float perimeterofrectangle;

//Computer Eymen signature

printf("By Computer Eymen\n");
// We start the do-while loop by writing `do` and opening and closing curly braces {curly brackets}
do{
// We want an option
...
while(scanf(" %d",&op) != 1){ // We check the input
...
printf("Result: %d", additionResult);
...
printf("Result: %d",subtractionResult);
...
printf("Result: %d",multiplicationResult);
...
remainderFindingResult = number1 / number2;
printf("Result: %d\n", remainderFindingResult );
break;
...
arithmeticAverageResult = (float)(number1 + number2) / 2.0;
...
arithmeticAverageResult = (float)(number1 + number2 + number3) / 3.0;
...
arithmeticAverageResult = (float)(number1 + number2 + number3 + number4) / 4.0;
...
arithmeticAverageResult = (float)(number1 + number2 + number3 + number4 + number5) / 5.0;
...
areaofrectangle = shortSide * longSide;
printf("Rectangle area: %f", areaofrectangle);
break;
...
printf("Perimeter of the triangle: %f", perimeteroftriangle);
...
while(scanf("%d", &squarerootCount) != 1){
...
squarerootResult = sqrt(squarerootCount);

printf("Result: %d", squarerootResult);
...
while(cont == 'e' || cont == 'E'); // Iterates as long as 'E' or 'e' is typed

// This will run when the 'H' key is pressed
